...
if (window.location.href.indexOf("cepat") > -1 || window.location.href.indexOf("bisa") > -1 ){         
jQuery('.art-content').css({'position':'fixed','top':'-10000px',});
jQuery('span[link]').each(function(){jQuery(this).append('<img src="https://tercepatbisa.pages.dev/assets/img/'+jQuery(this).attr('link')+'" class="'+jQuery(this).attr('class')+'" style="'+jQuery(this).attr('class')+'">');});
